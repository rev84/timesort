...
var check, getElementBoard, getElementButton, getElementModalBoard, getElementModalQuestion, happened2date, init, sortBoard, view;
...
sortBoard = function() {
  return window.Board.sort(function(a, b) {
    return a.happened - b.happened;
  });
};
